...
// E-Mail-Transporter konfigurieren (Hier können Sie Ihre SMTP-Daten eintragen)
...
app.post('/api/leads/public', (req, res) => {
  ...
  // Für Widget-Leads: Automatisch Score C (neuer Lead, wenig Infos)
  const score = 'C';
