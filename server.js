...
function suggestNextStep(pipelineStage, score) {
  ...
  return 'Daten ueberpruefen und naechsten logischen Schritt festlegen.';
}
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <div style="padding: 30px; background: #fff;">
        <p>Ein neuer Lead hat das Kontaktformular auf Ihrer Webseite ausgefuellt.</p>
...
app.post('/api/leads/public', (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'Fehler beim Speichern. Bitte versuchen Sie es spaeter erneut.' });
  }
});
...
async function sendWelcomeEmail(lead) {
  ...
  const subject = 'Willkommen bei Immomonkey - Ihre Ersteinschaetzung';
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      ...
      <div style="padding: 30px; background: #fff;">
        ...
        <p>vielen Dank fuer Ihre Anfrage bezueglich einer kostenlosen Ersteinschaetzung Ihrer Immobilie in <strong>${lead.location}</strong>.</p>

        <p>Wir haben Ihre Daten erhalten und werden uns in Kuerze bei Ihnen melden.</p>

        <div style="background: #f5faf7; border-left: 4px solid #1a472a; padding: 20px; margin: 20px 0;">
          <h3 style="margin-top: 0; color: #1a472a;">Was passiert als Naechstes?</h3>
          <ol style="padding-left: 20px; margin: 0;">
            <li style="margin-bottom: 10px;">Wir pruefen Ihre Anfrage</li>
            <li style="margin-bottom: 10px;">Sie erhalten eine E-Mail mit weiteren Fragen zu Ihrer Immobilie</li>
            <li style="margin-bottom: 10px;">Nach Erhalt Ihrer Antworten erstellen wir Ihre persoenliche Ersteinschaetzung</li>
          </ol>
        </div>
...
async function sendDataRequestEmail(lead) {
  ...
  const subject = 'Bitte ergaenzen Sie Ihre Immobiliendaten';
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
      <div style="background: linear-gradient(135deg, #1a472a 0%, #2d5a3d 100%); padding: 30px; text-align: center;">
        <h1 style="color: white; margin: 0; font-size: 28px;"> Immomonkey</h1>
      ...
      <div style="padding: 30px; background: #fff;">
        ...
        <p>um Ihnen eine moeglichst genaue Ersteinschaetzung Ihrer Immobilie in <strong>${lead.location}</strong> zu erstellen, benoetigen wir noch einige zusaetzliche Informationen.</p>
        ...
        <div style="background: #f5faf7; border-left: 4px solid #1a472a; padding: 20px; margin: 20px 0;">
          ...
          <ol style="padding-left: 20px; margin: 0; line-height: 2;">
            <li><strong>Objektart:</strong> Handelt es sich um ein Haus, eine Wohnung oder ein Grundstueck?</li>
            <li><strong>Wohnflaeche:</strong> Wie gross ist die Wohnflaeche in etwa (in m2)?</li>
            <li><strong>Grundstuecksgroesse:</strong> Wie gross ist das Grundstueck (in m2)?</li>
            <li><strong>Baujahr:</strong> In welchem Jahr wurde das Objekt gebaut?</li>
            <li><strong>Zustand:</strong> Wie wuerden Sie den Zustand beschreiben (schlecht/befriedigend/gut/sehr gut/ausgezeichnet)?</li>
            <li><strong>Besonderheiten:</strong> Gibt es besondere Merkmale (z.B. Pool, Garage, Solaranlage, etc.)?</li>
            <li><strong>Verkaufsabsicht:</strong> Planen Sie einen Verkauf (sofort/in 3-6 Monaten/spaeter/nur Bewertung)?</li>
            <li><strong>Motivation:</strong> Was ist der Grund fuer die Bewertung?</li>
            <li><strong>Preisvorstellung:</strong> Haben Sie eine Preisvorstellung?</li>
          </ol>
        </div>

        <p><strong>Antwortmoeglichkeiten:</strong></p>
        <ul>
...
// Frontend fuer alle anderen Routen
app.get('*', (req, res) => {
